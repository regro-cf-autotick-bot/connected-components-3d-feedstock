...
pixi add connected-components-3d
# for installing globally
pixi global install connected-components-3d
```
...
It is possible to list all of the versions of `connected-components-3d` available on your platform:
...
```
pixi search connected-components-3d --channel conda-forge
```
